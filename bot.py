...
# ============================================================
# 🌍 GLOBAL CONFIG (সংশোধিত)
# ============================================================

BOT_NAME = os.environ.get("BOT_NAME", "Cooker Zone")
BOT_TOKEN = os.environ.get("BOT_TOKEN", "8799150227:AAEM7HLL9m_fzONkhLYYEdVHAl2jUh4PPzU")  # ✅ ঠিক করা হয়েছে
ADMIN_IDS = os.environ.get("ADMIN_IDS", "5653849290").split(",")  # ✅ ঠিক করা হয়েছে
TARGET_GROUP_ID = os.environ.get("TARGET_GROUP_ID", "-1003543577960")  # ✅ ঠিক করা হয়েছে

LOGIN_URL = os.environ.get("LOGIN_URL", "http://www.timesms.net/login")  # ✅ ঠিক করা হয়েছে
OTP_URL = os.environ.get("OTP_URL", "http://www.timesms.net/client/SMSCDRStats")  # ✅ ঠিক করা হয়েছে
